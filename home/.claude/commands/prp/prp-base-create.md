...
- Start by reading and understanding the prp concepts `~/docs/prp/README.md`
...
Use `~/.templates/prp/prp_base.md` as your template structure - it contains all necessary sections and formatting.
...
Save as: `/tmp/plan/{feature-name}-plan.md`
