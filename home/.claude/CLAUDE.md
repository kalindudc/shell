...
This user has transitioned to OpenCode as their primary AI coding agent.
Shared agent instructions, commands, templates, and concepts live in the OpenCode config directory.
...
When referencing templates or concepts, use the paths above (e.g., `$HOME/.config/opencode/templates/pr.md`).
